...
class Music():
    def __init__(self,id=2984712321):
        self.id = str(id)
        self.url = "https://music.yanlinn.com/api/playlist/detail?id="+ self.id
    ...
    def get_songurl(self,song_id):
        url = "https://music.yanlinn.com/api/song/detail?id=" + str(song_id)
    ...
    def get_musicurl(self,music_id):
        url = "https://music.yanlinn.com/api/song/url?id=" + str(music_id)
