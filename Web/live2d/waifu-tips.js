...
// 后端接口
live2d_settings['modelAPI']             = 'https://live2d.yanlinn.com/';   // 自建 API 修改这里
...
live2d_settings['l2dVerDate']           = '2018.11.20'; // 版本更新日期
live2d_settings['homePageUrl']          = 'https://www.yanlinn.com/html/news';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://www.yanlinn.com';   // 关于页地址, '{URL 网址}'
