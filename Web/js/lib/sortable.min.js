...
var Sortable = function() {
    ...
    return _createClass(d, [{
        ...
        value: function() {
            ...
            n = e.reduce(function(t, e, n) {
                ...
                return e.style.transform = "translate3d(" + 0 + "px, " + 0 + "px, 0)",
    ...
    },
    {
        ...
        value: function() {
            ...
            e.forEach(function(e, t) {
                0 === t && (e.classList.add(i), n.dataLink = e.dataset.sjslink),
    ...
    },
    {
        ...
        value: function(e) {
            ...
            requestAnimationFrame(function t() { (i += s) <= 1 ? (e.style.opacity = i, requestAnimationFrame(t)) : (e.style.opacity = 1, n && n())
            })
        }
    },
    {
...
HTMLElement.prototype.sortablejs = HTMLElement.prototype.sortablejs ||
function(t) {
