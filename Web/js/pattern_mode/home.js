    ...
    if (pattern) {
        document.write(`
            <div class="item_list">
                ...
                <img src="img/logo/PT.png"/>
                </a>
            </div>
            <div class="item_list">
                <a href="https://azz.net/yanlin" target="_blank">
                <img src="img/logo/AZZ.png"/>
                </a>
            </div>
            <div class="item_list">
                <a href="https://afdian.net/@Yan-Linn" target="_blank">
                <img src="img/logo/AFD.png"/>
                </a>
            </div>
        `);
    } else {
        document.write(`
            <div class="item_list">
                <a href="https://www.aplaybox.com/u/178812252" target="_blank">
                <img src="img/logo/MZW.png"/>
                </a>
            </div>
        `);
    }
